...
public class NavigationActivity extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                mapboxMap.addOnMapClickListener(com.example.justintimecycling.ui.NavigationActivity.this);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        NavigationLauncher.startNavigation(com.example.justintimecycling.ui.NavigationActivity.this, options);
                    }
                });
            }
        });
    ...
    public boolean onMapClick(@NonNull LatLng point) {
        ...
        originLng = intent.getDoubleExtra("originLng", 0);
        ...
        Point originPoint = Point.fromLngLat(originLng, originLat);
