...
import com.example.justintimecycling.adapters.ChatMessageRecyclerAdapter;
import com.example.justintimecycling.models.ChatMessage;
        ...
        View.OnClickListener
{
    ...
    private void joinChatroom(){
        ...
        User user = ((UserClient)(getApplicationContext())).getUser();
        Log.d(TAG, "joinchatroom " + FirebaseAuth.getInstance().getUid() + " " + user.toString());
