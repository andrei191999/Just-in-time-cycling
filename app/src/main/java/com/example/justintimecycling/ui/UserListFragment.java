...
import com.example.justintimecycling.adapters.UserRecyclerAdapter;
import com.example.justintimecycling.models.ClusterMarker;
import com.example.justintimecycling.models.User;
import com.example.justintimecycling.models.UserLocation;
import com.example.justintimecycling.util.MyClusterManagerRenderer;
import com.example.justintimecycling.util.ViewWeightAnimationWrapper;
...
import static com.example.justintimecycling.util.Constants.MAPVIEW_BUNDLE_KEY;

public class UserListFragment extends Fragment implements
        OnMapReadyCallback, View.OnClickListener, GoogleMap.OnInfoWindowClickListener, UserRecyclerAdapter.UserListRecyclerClickListener {
    ...
    public void onInfoWindowClick(Marker marker) {
        Log.d(TAG, "oninfoclick marker" + marker.getTitle());
    ...
    private void initGoogleMap(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "mapViewBundle " + mapViewBundle);
        mMapView.onCreate(mapViewBundle);
        mMapView.getMapAsync(this);
    }

    //Determines the view boundary then sets the camera and sets the view
    private void setCameraView() {
        ...
        mGoogleMap.moveCamera(CameraUpdateFactory.newLatLngBounds(mMapBoundary, 5));
    }
